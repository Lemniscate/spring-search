 ...
 */
public class ElLikeSpecification<T> extends BaseSpecification<T> {

    private final String elProperty;

    public ElLikeSpecification(String key, String elProperty, Object payload, ConversionService conversionService) {
