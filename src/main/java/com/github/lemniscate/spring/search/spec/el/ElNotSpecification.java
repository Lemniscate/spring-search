 ...
 */
public class ElNotSpecification<T> extends BaseSpecification<T> {

    private final String elProperty;

    public ElNotSpecification(String key, String elProperty, Object payload, ConversionService conversionService) {
